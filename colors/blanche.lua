...
M.setup = function()
  ...
  vim.api.nvim_set_hl(0, "CursorLineNr",            { fg = c.fg, bg = c.bg, bold = true, underline = true })
  ...
  vim.api.nvim_set_hl(0, "Boolean",                 { fg = c.fg })
  ...
  vim.api.nvim_set_hl(0, "@comment",                { fg = c.comment, italic = true })
  vim.api.nvim_set_hl(0, "@constant",               { fg = c.fg })
  vim.api.nvim_set_hl(0, "@constant.builtin",       { fg = c.fg, italic = true })
  vim.api.nvim_set_hl(0, "@string",                 { fg = c.comment_doc, italic = true })
  vim.api.nvim_set_hl(0, "@character",              { fg = c.comment_doc })
  vim.api.nvim_set_hl(0, "@number",                 { fg = c.fg })
  vim.api.nvim_set_hl(0, "@boolean",                { fg = c.fg })
  vim.api.nvim_set_hl(0, "@float",                  { fg = c.fg })
  vim.api.nvim_set_hl(0, "@identifier",             { fg = c.fg })
  vim.api.nvim_set_hl(0, "@function",               { fg = c.comment_doc, underline = true })
  ...
  -- Lazy.nvim
  vim.api.nvim_set_hl(0, "LazyNormal",              { fg = c.fg, bg = c.bg })
  vim.api.nvim_set_hl(0, "LazyButton",              { fg = c.fg, bg = c.tab_inactive })
  vim.api.nvim_set_hl(0, "LazyButtonActive",        { fg = c.fg, bg = c.selection, bold = true })
  vim.api.nvim_set_hl(0, "LazyH1",                  { fg = c.bg, bg = c.fg, bold = true })
  vim.api.nvim_set_hl(0, "LazyH2",                  { fg = c.tab_fg, bold = true })
  vim.api.nvim_set_hl(0, "LazyProp",                { fg = c.comment })
  vim.api.nvim_set_hl(0, "LazyValue",               { fg = c.accent })
  vim.api.nvim_set_hl(0, "LazyDir",                 { fg = c.comment_doc, underline = true })
  vim.api.nvim_set_hl(0, "LazyUrl",                 { fg = c.comment_doc, underline = true })
  vim.api.nvim_set_hl(0, "LazyCommit",              { fg = c.accent })
  vim.api.nvim_set_hl(0, "LazyCommitType",          { fg = c.comment })
  vim.api.nvim_set_hl(0, "LazyProgressDone",        { fg = c.green, bold = true })
  vim.api.nvim_set_hl(0, "LazyProgressTodo",        { fg = c.inactive })
  vim.api.nvim_set_hl(0, "LazySpecial",             { fg = c.accent })
  vim.api.nvim_set_hl(0, "LazyReasonPlugin",        { fg = c.error })
  vim.api.nvim_set_hl(0, "LazyReasonRuntime",       { fg = c.warning })
  vim.api.nvim_set_hl(0, "LazyReasonStart",         { fg = c.info })

  -- Mason
  vim.api.nvim_set_hl(0, "MasonNormal",             { fg = c.fg, bg = c.bg })
  vim.api.nvim_set_hl(0, "MasonHeader",             { fg = c.bg, bg = c.fg, bold = true })
  vim.api.nvim_set_hl(0, "MasonHeaderSecondary",    { fg = c.bg, bg = c.accent, bold = true })
  vim.api.nvim_set_hl(0, "MasonHighlight",          { fg = c.accent })
  vim.api.nvim_set_hl(0, "MasonHighlightBlock",     { fg = c.bg, bg = c.accent })
  vim.api.nvim_set_hl(0, "MasonHighlightBlockBold", { fg = c.bg, bg = c.accent, bold = true })
  vim.api.nvim_set_hl(0, "MasonMuted",              { fg = c.comment })
  vim.api.nvim_set_hl(0, "MasonMutedBlock",         { fg = c.fg, bg = c.tab_inactive })
  vim.api.nvim_set_hl(0, "MasonHeading",            { fg = c.tab_fg, bold = true })
  vim.api.nvim_set_hl(0, "MasonLink",               { fg = c.comment_doc, underline = true })
  vim.api.nvim_set_hl(0, "MasonError",              { fg = c.error })
  vim.api.nvim_set_hl(0, "MasonWarning",            { fg = c.warning })
